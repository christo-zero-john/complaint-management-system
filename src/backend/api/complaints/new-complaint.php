...
try {
    ...
    $query = "INSERT INTO complaints(title, description, CiD, DiD, visibility, UiD, created) 
    VALUES ('$title',  '$description', '$category', '$department', '$visibility', '$user', '$created_on')";
    ...
    pushLog(
        "<div>
                ...
                <b>Visisbility</b>:   <i>$visibility</i>
                <b>User ID</b>:   <i>$user</i>
