      ...
      if (data.status === "error") {
        ...
        departments.forEach((department) => {
          ...
          getUserById(department.head).then((data) => {
            let departmentHeadName = data.name;
            console.log(departmentHeadName);
            document.getElementById("departments").innerHTML += `     
            <div class="department card col-10 col-md-11 col-lg-11 my-2 mx-md-2 py-3 hover-scale-11 transition-04" onclick="editDepartment('${
              department.id
            }')">
