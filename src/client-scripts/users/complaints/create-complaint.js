...
let fields = {
  ...
  "complaint-visibility": document.getElementById("complaint-visibility"),
};
      ...
      .then((data) => {
        ...
        if (data.status === "error") {
          data.errors.forEach((error) => {
            // If error is complaint already exists
            if (error.message === "Complaint Already Exists") {
              newNotification("Complaint already exists.");
            }
