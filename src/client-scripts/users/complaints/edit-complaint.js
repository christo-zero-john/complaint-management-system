console.log("edit complaint script loaded successfully");
 ...
 * empty-field class is added to the element if the field value is null when edit complaint is clicked.
